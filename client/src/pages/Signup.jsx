    ...
    <div className="min-h-screen bg-[#F8F5F1] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-stone-200 bg-white p-8 shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
          ...
          {/* Logo Name */}
          <h1 className="logo-font text-5xl font-semibold text-stone-900 text-center tracking-tight">
            Mimi & Me
          </h1>

          <p className="text-stone-500 text-center mt-2 text-sm leading-6">
            Every stitch, every design, carries a mother's love—made for moments
